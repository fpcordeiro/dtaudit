...
specific rules, dtaudit focuses on **understanding what happens** to your data
during joins, filters, and transformations --- helping you catch problems before
they become hard-to-find bugs.
...
information. These are typical inputs to a merge operation.
...
Before merging, check that your join keys actually identify rows uniquely in
each table.
...
**before** merging. This tells you the join type, match rates, and which keys
are unmatched.
